...
export function AppShell() {
  ...
  return (
    <div className="app-shell">
      ...
      {/* Mobile bottom nav — visible ≤720px */}
      <nav className="app-shell__mobile-nav">
        <button
          className="app-shell__mobile-link app-shell__mobile-link--pink"
          type="button"
          onClick={handleNewChat}
        >
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
          ...
          <span className="app-shell__mobile-label">New</span>
        </button>
        <NavLink to="/history" className="app-shell__mobile-link">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="12" cy="12" r="10" />
            <polyline points="12 6 12 12 16 14" />
          </svg>
          <span className="app-shell__mobile-label">History</span>
        </NavLink>
        <NavLink to="/pairs" className="app-shell__mobile-link">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <polyline points="22 12 18 12 15 21 9 3 6 12 2 12" />
          </svg>
          <span className="app-shell__mobile-label">Pairs</span>
        </NavLink>
        <NavLink to="/financials" className="app-shell__mobile-link">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <line x1="12" y1="1" x2="12" y2="23" />
            <path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6" />
          </svg>
          <span className="app-shell__mobile-label">Finance</span>
        </NavLink>
        <NavLink to="/about" className="app-shell__mobile-link">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
            <circle cx="12" cy="12" r="10" />
            <line x1="12" y1="16" x2="12" y2="12" />
            <line x1="12" y1="8" x2="12.01" y2="8" />
          </svg>
          <span className="app-shell__mobile-label">About</span>
        </NavLink>
      </nav>
    </div>
  )
